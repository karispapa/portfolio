...
const Experience = () => {
  const techs = [
    ...
    { name: reactImage, title: 'reactImage', style: 'shadow-blue-500' },
    { name: nextjs, title: 'Next JS', style: 'shadow-white' },
    { name: graphql, title: 'GraphQL', style: 'shadow-pink-400' },
  ...
  return (
    <div
      name="experience"
      className=" bg-gradient-to-b from-gray-800 to-black pt-28
     md:h-screen"
    >
      <div
